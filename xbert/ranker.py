...
class LinearModel(object):
    ...
    def train(cls, X, Y, C,
            ...
            Cp=1.0, Cn=1.0, threshold=0.1, max_iter=100, threads=-1, bias=-1.0, Z_pred=None):
...
class LinearTrainCommand(SubCommand):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument("-z", "--pred-inst-codes", type=str, metavar="PATH",
...
class LinearPredictCommand(SubCommand):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument("-t", "--transform", type=str, default='l3-hinge',
        ...
        parser.add_argument("-k", "--only-topk", type=int, default=10,
