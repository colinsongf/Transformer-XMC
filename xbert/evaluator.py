...
def print_ens(Y_true, Y_pred_list):
    for ens in [rf_linear.CsrEnsembler.average, rf_linear.CsrEnsembler.rank_average, rf_linear.CsrEnsembler.round_robin]:
...
if __name__ == '__main__':
    ...
    parser.add_argument("-y", "--input-inst-label", type=str, required=True,
